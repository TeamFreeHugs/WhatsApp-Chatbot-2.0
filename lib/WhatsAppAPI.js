...
function WhatsAppAPI() {
    return {
        ...
        reload: function () {
            ...
            this.attachElements.userTitle = $('h2.chat-title > span:nth-child(1)');
                    ...
                    if (mutation.addedNodes.length != 0) {
                        ...
                        for (var p1 = 0; p1 < handlers.length; p1++) {
                            ...
                            if (handlerNew !== undefined && handlerNew !== null) {
                                var html = $('<div>').html(latestMessageElement.html())[0];
                                var outputHTML = '';
            ...
            this.reload();
            var usersRaw = $('div.chat-status:nth-child(2) > span:nth-child(1)').attr('title');
